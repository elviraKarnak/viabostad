<?php get_header(); 
   ...
   <?php 
                  ...
                  <button class="add_to_wishlist_btn primary_btn">
                          ...
                          <span class="button_text">Save Property</span>
                        </button>

                      <!-- <div class="ac-interest-box">
                        <a href="javascript:void(0)" class="ac-interest-btn active" data-type="yes" data-id="<?php echo get_the_ID(); ?>">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tick.svg" width="19" height="19"> Yes
                        </a>

                        <a href="javascript:void(0)" class="ac-interest-btn" data-type="no" data-id="<?php echo get_the_ID(); ?>">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/cross.svg" width="19" height="19"> No
                        </a>
                      </div> -->
...
<script>
  jQuery(document).ready(function($) {
    ...
    var is_user_logged_in_flag = <?php echo is_user_logged_in() ? 'true' : 'false'; ?>;
    var login_url = "<?php echo wp_login_url( get_permalink() ); ?>";
    var ajax_url = "<?php echo admin_url('admin-ajax.php'); ?>";


     $('.ac-interest-btn').on('click', function (e) {
        e.preventDefault();
        ...
        var interest_type = $(this).data('type');
        var button = $(this);
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    ...
                    button.closest('.ac-interest-box')
                          .find('.ac-interest-btn')
                          .removeClass('active');
